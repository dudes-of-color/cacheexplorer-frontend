...
export default function LoginForm() {
  ...
  return (
    <div className="flex flex-col items-center justify-center h-full overflow-hidden bg-gray-700">
      ...
      {!user?.username && (
        <>
          <h1 className="pb-16 text-5xl font-bold pt-9">Log in</h1>
          <div className="w-10/12 bg-white md:6/12 shadow-3xl rounded-3xl bg-sky-500/50 lg:w-5/12">
            <div className="absolute p-4 transform -translate-x-1/2 -translate-y-1/2 bg-gray-800 left-1/2 md:p-8">
