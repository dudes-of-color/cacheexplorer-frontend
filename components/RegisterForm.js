...
export default function LoginForm() {
  ...
  function handlePasswordConfirmation(text) {
...
// Dismiss toast
  ...
  useEffect(() => {
    if (registerSuccess) {
      notify("success", "Successfully signed up! You may now use these credentials to log in")
      router.push('/Login')
    }

  }, [registerSuccess, passwordsMatch])
